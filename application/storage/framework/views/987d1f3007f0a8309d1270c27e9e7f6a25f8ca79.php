    ...
    <div class="login-box m-t-20">
        ...
        <form class="form-horizontal form-material" id="signUpForm">
            ...
            <div class="form-group text-center m-t-20">
                <div class="col-xs-12">
                    <button class="btn btn-info btn-lg btn-block" id="signupButton" data-button-loading-annimation="yes"
                        data-button-disable-on-click="yes" data-url="<?php echo e(url('signup')); ?>" data-ajax-type="POST"
                        data-loading-target="" data-loading-class="loading"
                        type="submit"><?php echo e(cleanLang(__('lang.sign_up'))); ?></button>
                </div>
            </div>
...
<?php echo $__env->make('layout.wrapperplain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elphill/Workdrive/localserver/laravel/GROWCRM/application/resources/views/pages/authentication/signup.blade.php ENDPATH**/ ?>