...
<tr id="task_<?php echo e($task->task_id); ?>" class="task-<?php echo e($task->task_status); ?>">
    ...
    <td class="tasks_col_status">
        <span
            class="label label-<?php echo e($task->taskstatus_color); ?>"><?php echo e(runtimeLang($task->taskstatus_title)); ?></span>
        <!--archived-->
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/elphill/Workdrive/localserver/laravel/GROWCRM/application/resources/views/pages/tasks/components/table/ajax.blade.php ENDPATH**/ ?>