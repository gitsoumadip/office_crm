...
<div class="kanban-card show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    ...
    <div class="x-footer row">
        <div class="col-6 x-icons">
            ...
            <span class="x-icon text-danger p-l-5  display-inline-block font-14 vm " data-toggle="tooltip" title="<?php echo app('translator')->get('lang.recurring_task'); ?>"><i
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/elphill/Workdrive/localserver/laravel/GROWCRM/application/resources/views/pages/tasks/components/kanban/card.blade.php ENDPATH**/ ?>